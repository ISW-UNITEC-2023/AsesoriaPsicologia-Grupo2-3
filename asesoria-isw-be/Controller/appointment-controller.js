...
async function updateOrder(req,res)
{
    try{
        ...
        res.send({ 
            message: "Se ha actualizado la orden medica" 
        });
...
async function updatePaymentMedic(req,res)
{
    try{
        ...
        res.send({ 
            message: "Se ha actualizado el pago medico" 
        });
...
async function updateObservations(req, res)
{
    try{
        ...
        res.send({ 
            message: "Se ha actualizado la observacion" 
        });
...
async function updateAppointment(req, res)
{
    try{
        ...
        res.send({ 
            message: "Se ha actualizado la fecha de cita" 
        });
...
async function updateStateMedic(req, res)
{
    try{
        ...
        res.send({ 
            message: "Se ha actualizado el estado medico" 
        });
...
async function getById(req, res) 
{
    try {
        ...
        res.send({
            appInfo: App,
            message: "Se ha recuperado la información de la cita por id",
        });

    } catch (error) {
        res.send({ 
            message: "No fue posible recuperar la información de la cita por id", 
            err: error.message
        });
    }
}
...
async function getDoctor(req, res) 
{
    try {
        ...
        res.send({
            ...
            appointmentsInfo: await appointmentServices.getDoctor(id) 
        });
...
async function getClinic(req, res) 
{
    try {
        ...
        res.send({
            appInfo: App,
            message: "Se ha recuperado la información de la clinica",
        });

    } catch (error) {
        res.send({ 
            message: "No fue posible recuperar la informacion de la clinica", 
            err: error.message 
        });
    }
  }
