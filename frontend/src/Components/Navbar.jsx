    ...
    return (
        <div id="navigation_bar" className="background">
            <div className="body-navbar-plataforma">
                ...
                <Link id="navigation_bar_tablero" to="/Dashboard" className="link-navbar-plataforma">
                    <FontAwesomeIcon
                        icon={faGaugeHigh}
                ...
                <Link id="navigation_bar_anuncios" to="/Anuncios" className="link-navbar-plataforma">
                    <FontAwesomeIcon
                        icon={faBullhorn}
                        className="navbar-plataforma-icon"
                    />
                ...
                <Link id="navigation_bar_zoom" to="/ZoomC" className="link-navbar-plataforma">
                    <FontAwesomeIcon icon={faVideo} className="navbar-plataforma-icon" />
                    Zoom
                </Link>
                <Link id="navigation_bar_calendario" to="/Calendario" className="link-navbar-plataforma">
                    <FontAwesomeIcon
                        icon={faCalendarDays}
                        className="navbar-plataforma-icon"
                    />
                ...
                <Link id="navigation_pacientes" to="/Pacientes" className="link-navbar-plataforma">
                    <FontAwesomeIcon
                        icon={faUserGroup}
                        className="navbar-plataforma-icon"
                    />
                ...
                <Link id="navigation_bar_cuentas" to="/Cuentas" className="link-navbar-plataforma">
                    <FontAwesomeIcon
                        icon={faAddressCard}
                        className="navbar-plataforma-icon"
                    />
