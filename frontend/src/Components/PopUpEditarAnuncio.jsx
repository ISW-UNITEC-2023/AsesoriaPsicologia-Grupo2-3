...
import { UpdateAnnouncesTitle, UpdateAnnouncesDecription } from "../Utilities/announces-services";

const PopUpEditarAnuncio = ({ show, onHide, announce_id, title, description }) => {
  ...
  return (
    ...
    >
      <Modal.Header className="justify-content-center">
        <Modal.Title className="text-center">Titulo Anuncio: {newTitle}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
      ...
      <Modal.Footer className="justify-content-start">
        ...
        <Button variant="primary" onClick={handleUpdate} style={{ backgroundColor: '#002659', border: 'none' }}>
          Actualizar
        </Button>
      </Modal.Footer>
    </Modal>
