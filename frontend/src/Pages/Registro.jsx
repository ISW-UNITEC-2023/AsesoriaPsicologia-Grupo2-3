...
function Wizard(props) {
    ...
    return (
        <div className="containerReg">
            ...
            <img src={RegisterDoctorImage} alt="Register Doctor" className="register-doctor-image" />
            ...
            <Form>
                                    ...
                                    <Form.Group controlId="formphoneNum" className="mb-3">
                                        ...
                                        <Form.Control
                                                ...
                                                onChange={(e) => handleRegChange(e)}
                                                onBlur={() => setTouchedFields({ ...touchedFields, phoneNum: true })}
                                                isInvalid={!regData.phoneNum.length > 0 && touchedFields.phoneNum}
                                                required
                                            />
                                        <Form.Control.Feedback type="invalid">
