		...
		<div className="account-container">
			...
			<div className="account-box">
				<div className="account-header">
					...
					{
						havePrivilege(verifyRef.current, [44]) &&
						<button
					...
					{ }
					{openEdit.open === 1 && (
						havePrivilege(verifyRef.current, [46]) &&
						<PopUpEditUser
            ...
            />
					...
					{openRole.open === 1 && (
						havePrivilege(verifyRef.current, [50]) &&
						<PopUpAdminRole
				...
				{
					havePrivilege(verifyRef.current, [45]) &&
				...
				<div className="pagination">
					{
						havePrivilege(verifyRef.current, [45]) ?
							...
							:
							<span className="pagination-text">
								No se pueden mostrar usuarios debido a que no tienes los permisos correspondientes.
							</span>
					}
					{
						havePrivilege(verifyRef.current, [45]) &&
