...
function LandingPage(props) {
    ...
    return (
        <div className="bg-white overflow-hidden">
            ...
            <main>
                <div className="sm:mx-auto sm:w-full sm:h-96 lg:mx-auto lg:w-full lg:h-auto">
                    <Slide {...slideProperties}>
                        {images.map((each, index) => (
                            <img
                                ...
                                src={each}
                                alt={`Slide ${index}`}
                                className="mx-auto w-auto h-60 lg:h-80"
                            />
                        ))}
                    </Slide>
                </div>
                <h1 className="text-center text-2xl lg:text-4xl">Atención Psicológica</h1>
                <hr className="w-4/5 mx-auto border-b-2 border-red-600" />
                <div className="video-and-box-container flex flex-col items-center justify-center lg:flex-row sm:flex-col
                    ...
                    <div className="relative w-96 h-96 bg-blue-900 rounded-lg mt-10">
                        ...
                        <div
                            ...
                            <p className="text-white text-center font-bold text-sm">
                                La incorporación de esta nueva plataforma permitirá fortalecer el esquema de atención
                                Psicológica y ayudará a mejorar tu salud Mental.
                            </p>
                        </div>
                    </div>
                </div>
                <h1 className="text-center text-3xl lg:text-4xl mt-4">Palabras Sobre la Pagina</h1>
                <hr className="w-4/5 mx-auto border-b-1 border-red-600 mb-4" />
                <div className="image-container lg:flex lg:flex-row lg:justify-between lg:items-center lg:space-x-10
                lg:mb-10 mr-5 ml-5 sm:flex sm:flex-col sm:justify-center sm:items-center">
                    <div className="lg:w-1/2 flex items-center justify-center">
                        <img src={iconomujer} alt="iconomujer" className="w-64 h-64 sm:ml-10 lg:0" />
                    </div>
                    <div className="lg:w-1/2 text-mujer text-center text-gray-700 mt-4 mb-4 md:mt-0 md:mb-0 lg:mt-0 lg:mb-0">
                        <p>
                            En tiempos de desafíos y cambios, la salud mental es primordial. En UNITEC, estamos
                            comprometidos a proporcionarte un espacio seguro donde puedas explorar tus pensamientos y
                            emociones, y trabajar juntos en el fortalecimiento de tu bienestar psicológico.
                        </p>
                    </div>
                    <div className="lg:w-1/2 flex items-center justify-center">
                        <img src={iconohombre} alt="iconohombre" className="w-64 h-64 sm:ml-10 md:0 lg:0" />
                    </div>
                    <div className="lg:w-1/2 text-hombre text-center text-gray-700 mt-4 mb-4 lg:mt-0 lg:mb-0">
                        <p>
                            La asistencia psicológica en UNITEC no solo se trata de afrontar dificultades, sino también
                            de potenciar tus fortalezas. Te invitamos a aprovechar nuestros recursos para desarrollar
                            habilidades emocionales y enfrentar los desafíos de la vida universitaria y más allá.
                        </p>
                    </div>
                </div>
            </main>
