        ...
        <main>
          ...
          >
            ...
            <div className="relative w-96 h-96 bg-blue-900 rounded-lg mt-10">
              ...
              />
              <div className="rounded-box2 w-80 h-24 bg-red-600 rounded-lg mt-64 absolute flex items-center justify-center ml-8">
                <p className="text-white text-center font-bold text-sm">
                  La incorporación de esta nueva plataforma permitirá fortalecer
                  el esquema de atención Psicológica y ayudará a mejorar tu
                  salud Mental.
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="lg:w-1/2 text-mujer text-center text-gray-700 mt-4 mb-4 md:mt-0 md:mb-0 lg:mt-0 lg:mb-0">
              <p>
                ...
                trabajar juntos en el fortalecimiento de tu bienestar
                psicológico.
              </p>
            </div>
            <div className="lg:w-1/2 flex items-center justify-center">
    ...
    <LandingLayout pagina="Inicio">
      <div className="Home">
        ...
        <main className="overflow">
          ...
          <h1 className="text-center text-2xl lg:text-4xl">Clinica Virtual</h1>
          <hr className="w-4/5 mx-auto border-b-2 border-red-600" />
          <div>
