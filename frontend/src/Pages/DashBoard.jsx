...
import PortadaDash from "../Styles/Images/Portada-Dashboard.png";
...
function DashBoard(props) {
  ...
  const handleScheduleClick = () => {
    const selectedPatient = nombre.find(
      (patient) => patient.id_account === selectedName
    );
    if (selectedPatient != null) {
      handleClick(
        selectedPatient.id_account,
        selectedPatient.nombre,
        selectedPatient.id_clinic
      );
  ...
  const handleViewDocumentsClick = () => {
    ...
    if (selectedPatient != null) {
      ...
      navigate("/Documentos", {
        state: { id_file: selectedPatient.id_file, userData: props.userData },
      });
    }
  };
              ...
              <div className="mt-4">
                ...
                {showButtons && selectedOption && (
                  <div className="custom-button">
                    ...
                    <Button onClick={handleViewDocumentsClick}>
                      Ver Documentos
                    </Button>
                  </div>
                )}
